...
const VideoSkipForward = ({style, fill, size}) => (
  <Svg width="25pt" height="25pt" viewBox="0 0 25 25">
    <Path
...
VideoSkipForward.propTypes = {
  style: PropTypes.any,
  fill: PropTypes.string,
  size: PropTypes.number,
};

VideoSkipForward.defaultProps = {
  style: {},
  fill: Colors.white,
  size: 24,
};

export default VideoSkipForward;

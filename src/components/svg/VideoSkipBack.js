...
const VideoSkipBackIcon = ({style, fill, size}) => (
  <Svg width="26pt" height="25pt" viewBox="0 0 26 25">
    <Path
...
VideoSkipBackIcon.propTypes = {
  style: PropTypes.any,
  fill: PropTypes.string,
  size: PropTypes.number,
};

VideoSkipBackIcon.defaultProps = {
  style: {},
  fill: Colors.white,
  size: 24,
};

export default VideoSkipBackIcon;
